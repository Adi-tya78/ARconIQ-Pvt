    ...
    >
      ...
      >
        <Link href="/" className="flex items-center gap-2">
          <Image src="/arconiq-logo-icon.png" alt="ARconIQ" width={36} height={36} className="w-9 h-9 object-contain" />
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="shimmer-btn bg-gradient-to-r from-cyan-500 to-blue-600 text-white hover:from-cyan-600 hover:to-blue-700 rounded-full px-4"
            asChild
          >
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button className="shimmer-btn bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full" asChild>
              <a href="#contact">Get in Touch</a>
            </Button>
          </div>
        </motion.div>
